...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-2xl bg-muted/30">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-muted/50 [&_tr]:border-b border-border/50", className)} {...props} />
))
